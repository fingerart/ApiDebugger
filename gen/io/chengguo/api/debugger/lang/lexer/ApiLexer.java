...
class ApiLexer implements FlexLexer {
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\1\10\1\11\1\12\1\13\1\5\1\14\1\13\1\15"+
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return ApiTypes.Api_KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return ApiTypes.Api_COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return ApiTypes.Api_SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return ApiTypes.Api_VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
